...
1. 打开浏览器：`http://localhost:5001/html/cloud_disk.html`
...
```javascript
// 测试树形结构生成
fetch('http://localhost:5001/api/cloud_disk/files?user_id=21', {
...
```javascript
fetch('http://localhost:5001/api/cloud_disk/create-folder', {
  method: 'POST',
  headers: {
